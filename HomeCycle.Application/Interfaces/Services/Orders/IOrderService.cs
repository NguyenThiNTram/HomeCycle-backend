...
namespace HomeCycle.Application.Interfaces.Services.Orders
{
    public interface IOrderService
    {
        ...
        Task<Result<OrderCancellationResponseDto>> CancelOrderAsync(Guid orderId, Guid userId, CancellationToken ct = default);
        Task<Result<OrderReturnConfirmationResponseDto>> ConfirmReturnByBuyerAsync(
            Guid orderId,
            Guid buyerId,
            CancellationToken ct = default);

        Task<Result<OrderReturnConfirmationResponseDto>> ConfirmReturnReceivedBySellerAsync(
            Guid orderId,
            Guid sellerId,
            CancellationToken ct = default);
